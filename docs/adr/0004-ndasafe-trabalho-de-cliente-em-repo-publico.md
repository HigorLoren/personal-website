...
A regra existe porque a restrição vem do NDA, não do código — sem esta nota, alguém poderia "consertar" o branch achando que é um bug e vazar material privado.
Alternativas descartadas: omitir os cases de cliente (perde prova de trabalho) ou manter o repo privado (o site é ele mesmo a primeira prova de ofício).
